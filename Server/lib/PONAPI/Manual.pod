# ABSTRACT: Manual for PONAPI::Server
...
composing your own SQL.  In the repository used for testing PONAPI::Server,
we used L<SQL::Composer>.  The manual will continue rolling it's own SQL, but
