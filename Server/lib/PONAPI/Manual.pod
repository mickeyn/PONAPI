...
composing your own SQL.  For the final sample implementation, found in
L<Test::PONAPI::DAO::Repository::MockDB>, we used L<SQL::Composer>; for
the rest of this document will still roll it's own SQL, but please don't
